defmodule Pxblog.UserControllerTest do
  ...
  @valid_create_attrs %{email: "foo@example.com", password: "foo",
    password_confirmation: "foo", username: "testuser"}
  @valid_attrs %{email: "foo@example.com", username: "testuser"}
  @invalid_attrs %{}
  ...
  setup do
    ...
    {:ok, nonadmin_user} = TestHelper.create_user(user_role,
      %{email: "nonadmin@test.com", username: "nonadmin",
    ...
    {:ok, conn: conn, user_role: user_role,
      admin_role: admin_role, nonadmin_user: nonadmin_user,
